...
_DISRUPTION_CONTEXT_NOTE = (
    ...
    "morning\", \"take it all off, I'm not doing any of it\"). Get the real "
    "session ids first, from the tool that covers the day they mean: "
    "list_todays_sessions for TODAY, and list_sessions for ANY OTHER day or "
    "span — \"clear Friday, something came up\" is start_date that Friday with "
    "days 1, \"I'm away tomorrow\" is start_date tomorrow, \"write off this "
    "week\" is days 7. Never assume they mean today. Then work out which "
    "sessions they actually mean — for a full clear that is list_sessions' "
    "`actionable_ids`, which includes the missed ones still sitting on the day, "
    "not just `planned_ids` — and cancel exactly those with cancel_sessions (it "
    "removes the session and keeps the task). Do not re-book them anywhere; they asked "
